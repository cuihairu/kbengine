...
/*
	½«³£ÓÃÊý¾ÝÀàÐÍ¶þ½øÖÆÐòÁÐ»¯Óë·´ÐòÁÐ»¯
	×¢Òâ£º¶ËÓë¶ËÖ®¼ä´«Êä¿ÉÄÜÉæ¼°´óÐ¡¶ËÎÊÌâ£¬¿ÉÒÔÍ¨¹ýÈçÏÂ½øÐÐ×ª»»½øÐÐ×ª»»:
...
public:
    ...
    void appendPackXZ(float x, float z)
    {
		...
		// 0-7Î»´æ·ÅÎ²Êý, 8-10Î»´æ·ÅÖ¸Êý, 11Î»´æ·Å±êÖ¾
		// ÓÉÓÚÊ¹ÓÃÁË24Î»À´´æ´¢2¸öfloat£¬ ²¢ÇÒÒªÇóÄÜ¹»´ïµ½-512~512Ö®¼äµÄÊý
		// 8Î»Î²ÊýÖ»ÄÜ·Å×î´óÖµ256, Ö¸ÊýÖ»ÓÐ3Î»(¾ö¶¨¸¡µãÊý×î´óÖµÎª2^(2^3)=256) 
		// ÎÒÃÇÉáÈ¥µÚÒ»Î»Ê¹·¶Î§´ïµ½(-512~-2), (2~512)Ö®¼ä
		// Òò´ËÕâÀïÎÒÃÇ±£Ö¤×îÐ¡ÊýÎª-2.f»òÕß2.f
		...
		// ÕâÀïÈç¹ûÕâ¸ö¸¡µãÊýÒç³öÁËÔòÉèÖÃ¸¡µãÊýÎª×î´óÊý
		// ÕâÀï¼ì²éÁËÖ¸Êý¸ß4Î»ºÍ±ê¼ÇÎ»£¬ Èç¹û¸ßËÄÎ»²»Îª0Ôò¿Ï¶¨Òç³ö£¬ Èç¹ûµÍ4Î»ºÍ8Î»Î²Êý²»Îª0ÔòÒç³ö
		...
		// ¸´ÖÆ8Î»Î²ÊýºÍ3Î»Ö¸Êý£¬ Èç¹û¸¡µãÊýÊ£ÓàÎ²Êý×î¸ßÎ»ÊÇ1Ôò+1ËÄÉáÎåÈë, ²¢ÇÒ´æ·Åµ½dataÖÐ
		// 0x7ff000 = 11111111111000000000000
		// 0x0007ff = 00000000000011111111111
