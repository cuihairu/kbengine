...
- `kbe/src/lib/network/channel.cpp:41` `Channel::createPoolObject`
- `kbe/src/lib/network/channel.cpp:182` `Channel::initialize`
...
- `kbe/src/lib/network/channel.cpp:747` `Channel::send`
- `kbe/src/lib/network/channel.cpp:888` `Channel::stopSend`
- `kbe/src/lib/network/channel.cpp:910` `Channel::onSendCompleted`
...
对应实现见 `kbe/src/lib/network/channel.cpp:1033`：
...
关键逻辑见 `kbe/src/lib/network/network_interface.cpp:432`：
...
`Channel::destroy()` 本身很薄，真正的清理在 `clearState()`，见 `kbe/src/lib/network/channel.cpp:533`。
