...
[KBEngine](./KBEngine.md)模块提供了Python脚本控制对特定类型的日志进行分析和转储等能力。
...
- def [onLoggerAppReady](#onLoggerAppReady)( ):
- def [onLoggerAppShutDown](#onLoggerAppShutDown)( ):
- def [onLogWrote](#onLogWrote)( datas ):
